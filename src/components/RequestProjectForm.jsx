...
const RequestProjectForm = React.forwardRef(({ project, onSubmit, onCancel }, ref) => {
  ...
  const [semestre, setSemestre] = useState(project?.semestre || ""); // Nuevo estado para semestre
  ...
  const handleSubmit = (e) => {
    ...
    fd.append("semestre", semestre.trim()); // Añadir semestre al FormData
        ...
        <div className="space-y-4">
          <div className="grid gap-x-6 gap-y-5 md:grid-cols-2">
            ...
            <div>
              ...
              <input className="input" value={semestre} onChange={(e) => setSemestre(e.target.value)} placeholder="Ej. 2024-1" required />
            </div>
